"""Landing page — marketing-style hero introducing Purch and linking
into the chat/login experience. This is the public root of the Reflex
shell; the authenticated experience lives at /chat."""
