...
once we pick a provider (see MIGRATION.md §7).
...
class AuthState(rx.State):
    ...
    # UI status for the login page.
    oauth_status: str = "idle"
    oauth_error: str = ""

    @rx.event
    def begin_google_login(self):
        """Phase 2 stub — surfaces a clear 'not yet available' message
        instead of failing silently. Phase 3 replaces this with the real
